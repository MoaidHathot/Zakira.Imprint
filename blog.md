...
A few weeks ago, I found myself in a situation where I needed to share a set of Skills between multiple projects. I was also working on an internal library that LLMs simply did not know about, and I needed a way to teach them.
...
Imprint is a set of packages that enables distributing AI configurations like Skills and MCPs via NuGet. The concept is simple:
